!function(){
	...
	var c1=[-150, 40], c2=[-50, 170], c3=[-10, 210]; //Column positions of labels.
	var colors =["#FF9100", "#FFB400",  "#005A84","#0083BF", "#46166B", "#6234A4", "#FF8000", "#FFA200", "#DC0A0A", "#387C2B","#78A22F","#A00000","#DC0A0A","#A0968C"];
	...
	function drawHeader(header, id){
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text("References").attr("x", (c2[d]-10))
				.attr("y", -5).style("fill","grey");
